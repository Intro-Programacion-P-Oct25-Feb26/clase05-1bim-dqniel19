...
public class Ejemplo2 {
    ...
    public static void main(String[] args) {
        ...
        if (promedio >= 7.5) {
            System.out.printf("Estudiante %s de %d años residente de la ciudad "
                    + "de %s aprobado con un promedio: %.2f\n", 
                    miNombre, edad, ciudad, promedio);
        }else{
            System.out.printf("Estudiante %s de %d años residente "
                    + "de la ciudad %s con un promedio: %.2f\n", 
                    miNombre, edad, ciudad, promedio);
        }
    }
